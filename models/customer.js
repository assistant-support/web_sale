...
const FormSchema = new Schema(
    {
        ...
        care: { type: [{ content: String, createBy: { type: Schema.Types.ObjectId, ref: 'user' }, createAt: { type: Date, default: Date.now } }], default: [] },
        zaloavt: String,
        zaloname: String,
        assignees: { type: [{ user: { type: Schema.Types.ObjectId, ref: 'user' }, group: { type: String, enum: ['internal', 'external'] }, assignedAt: { type: Date, default: Date.now } }], default: [] },
        pipelineStatus: {
            type: String,
