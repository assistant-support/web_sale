...
export async function getDriveClient() {
    ...
    try {
        if (DRIVE_DEBUG) {
            const about = await drive.about.get({ fields: 'user, storageQuota', supportsAllDrives: true, });
            dlog('about.get OK:', {
...
export async function uploadBufferToDrive({
    ...
    try {
        createResp = await drive.files.create({
            ...
            media,
            fields: 'id, name, webViewLink, webContentLink, thumbnailLink, driveId, parents',
